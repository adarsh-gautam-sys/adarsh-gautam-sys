...
# ===========================================================================
HOST = "adarsh-gautam-sys"   # shown as  adarsh-gautam-sys@github  in the header
...
ROWS = [
    ...
    ("kv", "AI Libs",   "LangChain, Gemini, OpenAI, HuggingFace"),
    ("kv", "Infra",     "Vercel, GCP Cloud Run, GitHub Actions"),
